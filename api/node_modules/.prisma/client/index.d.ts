...
export namespace Prisma {
  ...
  */
  ...
  type GetCatsGroupByPayload<T extends CatsGroupByArgs> = PrismaPromise<
    Array<
  ...
  export type CatsGetPayload<
    S extends boolean | null | undefined | CatsArgs,
    U = keyof S
      > = S extends true
        ? Cats
    : S extends undefined
    ? never
    : S extends CatsArgs | CatsFindManyArgs
    ?'include' extends U
    ? Cats 
    : 'select' extends U
    ? {
  ...
  export interface CatsDelegate<GlobalRejectSettings> {
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Cats'> extends True ? CheckSelect<T, Prisma__CatsClient<Cats>, Prisma__CatsClient<CatsGetPayload<T>>> : CheckSelect<T, Prisma__CatsClient<Cats | null >, Prisma__CatsClient<CatsGetPayload<T> | null >>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Cats'> extends True ? CheckSelect<T, Prisma__CatsClient<Cats>, Prisma__CatsClient<CatsGetPayload<T>>> : CheckSelect<T, Prisma__CatsClient<Cats | null >, Prisma__CatsClient<CatsGetPayload<T> | null >>
    ...
    **/
    ...
    ): CheckSelect<T, PrismaPromise<Array<Cats>>, PrismaPromise<Array<CatsGetPayload<T>>>>
    ...
    **/
    ...
    ): CheckSelect<T, Prisma__CatsClient<Cats>, Prisma__CatsClient<CatsGetPayload<T>>>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends CatsAggregateArgs>(args: Subset<T, CatsAggregateArgs>): PrismaPromise<GetCatsAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, CatsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCatsGroupByPayload<T> : PrismaPromise<InputErrors>
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__CatsClient<T> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
   ...
   * Cats findUnique
   */
  export type CatsFindUniqueArgs = {
    /**
    ...
    **/
    ...
    /**
     * Throw an Error if a Cats can't be found
     * 
    **/
    rejectOnNotFound?: RejectOnNotFound
    /**
