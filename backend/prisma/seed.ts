...
const postData: DataProps[] = [
  ...
  },
  {
    ...
    content:
      'Neste jogo você joga como xerife em um belo mundo de pixel art, salva a cidade e todo o velho oeste dos bandidos e se torna The Old West Saviour![spacer height="20px"]<strong>Links:</strong><p style="text-align: center;"><a href="https://store.steampowered.com/app/1298100/The_Old_West_Savior/?fbclid=IwAR3P9VpCBNRMyq3icuXH9dvYBqQhdc7azUSSwBIre8KB9WO2MmFFZOMENq4" target="_blank" rel="noopener noreferrer">Steam</a></p><p style="text-align: center;"><a href="https://www.facebook.com/rafaelferreirammartins/" target="_blank" rel="noopener noreferrer">Desenvolvedor</a></p>[spacer height="20px"]<p style="text-align: center;"><iframe src="https://www.youtube.com/embed/uHiTcoEexoo" width="560" height="315" frameborder="0" allowfullscreen="allowfullscreen"></iframe></p>',
    category: 'Plataforma',
