      ...
      <Admin>
        <div className="updateContent">
          <div className="updateContent-field">
            <button onClick={create}>{isscheduled ? "Agendar" : "Publicar"}</button>
            Nome:
            <input type="text" onChange={(e) => setName(e.target.value)} value={name} />
            <div>
              Agendar
              <input type="checkbox" onClick={(e) => setisScheduled((e.target as HTMLInputElement).checked)} />
              {isscheduled ? (
                <input
                  type="datetime-local"
              ...
              <input
                type="checkbox"
                onClick={(e) => setSlide((e.target as HTMLInputElement).checked)}
                defaultChecked={slide ? true : null}
              />
              Meio
              <input
                type="checkbox"
                onClick={(e) => setMiddle((e.target as HTMLInputElement).checked)}
                defaultChecked={middle ? true : null}
              />
              Gameplay
              <input
                type="checkbox"
                onClick={(e) => setGameplay((e.target as HTMLInputElement).checked)}
                defaultChecked={gameplay ? true : null}
              />
              midSection
              <input
                type="checkbox"
                onClick={(e) => setMidSection((e.target as HTMLInputElement).checked)}
