                ...
                <div key={i} className="posts">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onClick={(e) =>
                        updateOption({
                          variables: { id: res.id, input: "slide", info: (e.target as HTMLInputElement).checked },
                        })
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onClick={(e) =>
                        updateOption({
                          variables: { id: res.id, input: "middle", info: (e.target as HTMLInputElement).checked },
                        })
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onClick={(e) =>
                        updateOption({
                          variables: { id: res.id, input: "gameplay", info: (e.target as HTMLInputElement).checked },
                        })
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onClick={(e) =>
                        updateOption({
                          variables: { id: res.id, input: "publicpost", info: (e.target as HTMLInputElement).checked },
                        })
                      }
